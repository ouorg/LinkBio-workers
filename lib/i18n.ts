...
const en: Dict = {
  ...
  "admin.data.importConfirm": "Import overwrites matching profile, links, settings, analytics, and backup config. Continue?",
...
const zhCN: Dict = {
  ...
  "admin.data.importConfirm": "导入会覆盖对应的资料、链接、设置、统计和备份配置。确定继续？",
